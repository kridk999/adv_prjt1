...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default='mnist', choices=['tg', 'cb', 'mnist'], help='toy dataset to use {tg: two Gaussians, cb: chequerboard, mnist: MNIST} (default: %(default)s)')
    ...
    # Generate the data
    n_data = 10000000 if args.data != 'mnist' else 100000
